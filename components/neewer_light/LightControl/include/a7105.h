...
class A7105 {
    public:
         ...
         */
        A7105(uint8_t cs, uint32_t freqHz = A7105_SPI_FREQUENCY);
        ~A7105();
    ...
    private:
        ...
        inline void assertChipSelect() { digitalWrite(_cs, LOW); delayMicroseconds(1); }
        inline void deassertChipSelect() {  delayMicroseconds(1); digitalWrite(_cs, HIGH); }
};
